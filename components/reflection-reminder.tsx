...
export default function ReflectionReminder() {
  ...
  useEffect(() => {
    ...
    // If no check-in today, show reminder after 3 seconds
            ...
            <Card className="border-2 border-purple-200 shadow-lg">
              <CardHeader className="relative pb-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <CardTitle>Daily Reflection Reminder</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <div className="space-y-4 py-2">
                  <p>
                    You haven't completed your daily reflection yet. Taking a moment to reflect helps track your
